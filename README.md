# Projeto Carrinho de Compras - C06

Este projeto foi desenvolvido para a disciplina de Programação Orientada a Objetos (C06-C), com o objetivo de simular um sistema de carrinho de compras utilizando Java.
...
Para execução do projeto, abra a classe `Main.java` e rode o método `main`.
o sistema possui um menu no terminal para testar as principais funcionalidades.